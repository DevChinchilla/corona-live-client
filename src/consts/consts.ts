...
다음날 제공되는 질병관리청 수치보다 적게 나오는 이유는 지자체에서 당일 확진자를 질병관리청에는 통보하지만 재난 문자는 다음날 보내는 경우때문입니다 (주로 늦은 시간 확진자가 발생하거나 역학조사가 완료되지 않았을 경우). <br><br> 검역과 대구는 당일발생 확진자 정보를 다음날 제공해서 집계를 할수없습니다 (지역사회 해외유입은
