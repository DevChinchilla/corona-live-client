...
<strong>이용전 필독 부탁드립니다</strong><br><br> 1.  코로나 라이브는 재난문자와 각 지자체및 질병관리본부에서 금일 제공하는 공식적인 자료를
기반으로 코로나 현황을 실시간으로 제공 하고있습니다.<br><br> 2.  <strong>오늘 확진 판정받은</strong> 확진자분들만 오늘발생 확진자로 포함합니다 (당일 확진자 발생 재난문자가 와도 어제 확진 판정된 확진자는 미포함 합니다).<br><br> 3. 몇몇 지자체에서는 당일 확진 판정받은 확진자를 다음날 공개를 하여 이럴 경우 코로나 라이브에 오늘 수치로 <strong>반영이 안 됩니다</strong>. 검역 또한 반영이 안 됩니다.<br><br>4. 이와같은경우로 다음날 제공하는 질본 수치와 <strong> 오차가 발생할수 있습니다</strong> <br><br>5. 민간이 취합한 집계이므로 공식적인 근거 자료로 활용될수 없습니다.
<br><br>  6. 본사이트에서 제공하는 정보 사용/공유로 인해 발생된 문제의 책임은<strong>
